class GameWorldWindow extends GameWindow {
  ...
  createGameObjectArrays() {
    this.gameObjects = {
      /** @type Array<GameObject> */ gameObject: [],
      /** @type Array<GameObject> */ cluster: [],
      /** @type Array<GameObject> */ debris: [],
      /** @type Array<GameObject> */ camera: [],
      /** @type Array<GameObject> */ projectile: [],
      /** @type Array<GameObject> */ asteroid: [],
      /** @type Array<GameObject> */ ship: [],
      /** @type Array<GameObject> */ station: [],
      /** @type Array<GameObject> */ satellite: [],
      /** @type Array<GameObject> */ fragment: [],
      /** @type Array<GameObject> */ person: [],
      /** @type Array<GameObject> */ npc: [],
      /** @type Array<GameObject> */ player: [],
      /** @type Array<GameObject> */ interactable: [],
      /** @type Array<GameObject> */ hint: [],
      /** @type Array<GameObject> */ laser: [],
      /** @type Array<GameObject> */ ultraportBeacon: [],
      /** @type Array<GameObject> */ hintGraphic: [],
      /** @type Array<GameObject> */ gameOverlay: [],
      /** @type Array<GameObject> */ pickup: [],
      /** @type Array<GameObject> */ explosion: [],
      /** @type Array<GameObject> */ particle: [],
      /** @type Array<GameObject> */ spawner: [],
      /** @type Array<GameObject> */ decorativeObject: [],
      /** @type Array<Decoration> */ decoration: [],
      /** @type Array<GameObject> */ lightSource: [],
      /** @type Array<GameObject> */ audioEmitter: [],
      /** @type Array<GameObject> */ mapIcon: [],
      /** @type Array<GameObject> */ mapImage: [],
      /** @type Array<GameObject> */ mapLabel: [],
    }
  }
  //#endregion
