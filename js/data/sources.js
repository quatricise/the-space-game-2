let sources = {
  img: {
    ship: {
      ...
      communistFighterI: {
        folder: "./assets/ship/communistFighterI/",
        auto: [
          "thumbnail",
          "shieldHardLightFront",
          "vwbOutline",
    ...
    projectile: {
      ...
      lava: {
        folder: "./assets/projectile/lava/",
        auto: ["linework"],
      },
      lavaBig: {
        folder: "./assets/projectile/lavaBig/",
        auto: ["linework"],
      },
      lavaSmall: {
        folder: "./assets/projectile/lavaSmall/",
        auto: ["linework"],
      },
    },
    ultraportBeacon: {
